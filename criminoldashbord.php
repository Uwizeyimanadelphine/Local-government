...
$sql = "SELECT * FROM criminolrecord";
...
. $row["mothername"]. "</td><td>" . $row["status"]. "</td><td>"  . $row["sex"]. "</td><td>" . $row["dateofbirth"]. "</td><td>" . $row["province"]. "</td><td>" . $row["district"]. "</td><td>". $row["sector"]. "</td><td>" . $row["village"]. "</td><td>" . $row["cell"]. "</td>"  
	?>
	<td><a href="viewcriminol.php?id=<?php echo $row['c_id'];?>"> view </a></td>
		<td><a href="productdetails.php?id=<?php echo $row['c_id'];?>"> update </a></td>
		<td><a href="deletecriminol.php?id=<?php echo $row['c_id'];?>"> delete </a></td>
	<?php
	"<br/></tr>";
}	
}
