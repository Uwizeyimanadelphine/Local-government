...
. $row["mothername"]. "</td><td>" . $row["status"]. "</td><td>"  . $row["sex"]. "</td><td>" . $row["dateofbirth"]. "</td><td>" . $row["province"]. "</td><td>" . $row["district"]. "</td><td>". $row["sector"]. "</td><td>" . $row["village"]. "</td><td>" . $row["cell"]. "</td>" 
	?>
	<td><a href="viewID.php?id=<?php echo $row['i_id'];?>"> view </a></td>
		<td><a href="productdetails.php?id=<?php echo $row['i_id'];?>"> update </a></td>
		<td><a href="deleteID.php?id=<?php echo $row['i_id'];?>"> delete </a></td>
	<?php
	"<br/></tr>";
}	
}
