...
echo "<tr><td>" . $row["names"]. "</td><td>" . $row["email"] . "</td><td>" 
. $row["telephone"]. "</td><td>" . $row["subject"]. "</td><td>" . $row["comment"]. "</td>"  
	?>
		<td><a href="viewmsg.php?id=<?php echo $row['contact_id'];?>"> view </a></td>
	<td><a href="productdetails.php?id=<?php// echo $row['d'];?>"> update </a></td>
		<td><a href="deletemsg.php?id=<?php echo $row['contact_id'];?>"> delete </a></td>
