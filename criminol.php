...
li a:hover {
 ...
 <li><a href="call.php">CONTACTUS</a></li>
	 ...
	 <center>
	 <form action="criminol.php" method="POST">
...
$sql = "INSERT INTO criminolrecord (fname,lname,email,telephone,fathername,mothername,status,sex,dateofbirth,province,district,sector,village,cell)
